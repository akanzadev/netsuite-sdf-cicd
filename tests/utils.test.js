...
// --- formatDate ---
console.log('\nformatDate');
assert(utils.formatDate(new Date('2024-01-05')) === '2024-01-05', 'formats a valid date');
assert(utils.formatDate(new Date('2024-12-31')) === '2024-12-31', 'formats end of year');
try {
...
// --- isNonEmptyString ---
console.log('\nisNonEmptyString');
assert(utils.isNonEmptyString('hello') === true, 'returns true for non-empty string');
assert(utils.isNonEmptyString('') === false, 'returns false for empty string');
assert(utils.isNonEmptyString('   ') === false, 'returns false for whitespace-only string');
